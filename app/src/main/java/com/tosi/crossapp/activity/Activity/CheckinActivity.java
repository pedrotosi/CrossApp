        ...
        botaoCheckin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(turma > 0) {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            if (checagem == 0) {
                                ...
                                if (count < 5) {
                                    ...
                                    Toast.makeText(CheckinActivity.this, "Checkin realizado!", Toast.LENGTH_LONG).show();
                                } else {
                                    Toast.makeText(CheckinActivity.this, "Turma lotada!", Toast.LENGTH_LONG).show();
                                }
                            } else if(checagem == 1) {
                                Toast.makeText(CheckinActivity.this, "Checkin já realizado em outra turma", Toast.LENGTH_LONG).show();
                            }else {
                                Toast.makeText(CheckinActivity.this, "Checkin já realizado!", Toast.LENGTH_LONG).show();
                            }
                        }
                    ...
                    Toast.makeText(CheckinActivity.this, "Favor escolher um horário!", Toast.LENGTH_LONG).show();
                }
            }
        });
                    ...
                    referenciaUser.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            if ((checagem == 0)|| (checagem == 1) ) {
                                Toast.makeText(CheckinActivity.this, "Checkin inexistente nesta turma", Toast.LENGTH_LONG).show();
                            }else {
                                DatabaseReference referenciaUser = configFireBase.getFirebase();
                                ...
                                Toast.makeText(CheckinActivity.this, "Checkin cancelado", Toast.LENGTH_LONG).show();
                            }
                        }
                        @Override
                        public void onCancelled(@NonNull DatabaseError databaseError) {
